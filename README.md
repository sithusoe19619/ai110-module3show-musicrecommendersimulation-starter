...
See [Model Card → Evaluation](model_card.md) for the full experiment writeup.

---

## Limitations and Risks

See [Model Card → Limitations and Bias](model_card.md) for a full breakdown.

---

## Reflection

See [Model Card → Personal Reflection](model_card.md) for the full reflection.
